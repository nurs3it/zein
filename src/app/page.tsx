      ...
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            создавать авторские работы, презентации и методички за минуты, а не часы. Искусственный
            интеллект берет рутину на себя.
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-12 text-blue-100 text-sm">
            <p>✨ Бесплатная пробная версия на 14 дней • Без привязки карты • Техподдержка 24/7</p>
          </div>
        </div>
      </section>
